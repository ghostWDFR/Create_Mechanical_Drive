...
final class RegularWormGearPonderScenes {
    private RegularWormGearPonderScenes() {
    }

    static void register(PonderSceneRegistrationHelper<ResourceLocation> helper) {
        helper.forComponents(
                        loc("worm_gear_regular")
                )
                .addStoryBoard(
                        WORM_GEAR_SCHEMATIC,
                        RegularWormGearPonderScenes::operation
                )
                .addStoryBoard(
                        WORM_GEAR_SCHEMATIC,
                        RegularWormGearPonderScenes::cascade
                )
                .addStoryBoard(
                        WORM_GEAR_SCHEMATIC,
                        RegularWormGearPonderScenes::backdrive
                );
    }
    ...
    private static void operation(
        ...
        WormGearPonderSceneShared.operation(builder, util, false);
    }
    ...
    private static void cascade(
        ...
        WormGearPonderSceneShared.cascade(builder, util, false);
    }
    ...
    private static void backdrive(
        ...
        WormGearPonderSceneShared.backdrive(builder, util, false);
    }
}
