...
public final class WormGearSmallKinetics {

    public static final float FIRST_STAGE_MULTIPLIER = 8.0F;
    public static final float SECOND_STAGE_MULTIPLIER = 4.0F;
    public static final float THIRD_STAGE_MULTIPLIER = 2.0F;
    public static final float LATER_STAGE_MULTIPLIER = 1.0F;

    public static final float BACKDRIVE_BREAK_THRESHOLD = 1024.0F;

    private WormGearSmallKinetics() {
    }

    public static WormGearSmallBlockEntity
    findAdjacentWorm(
    ...
    public static int getWormStageDepth(
        ...
        for (int i = 0; i < 32; i++) {
            ...
            WormGearSmallBlockEntity drivingWorm =
