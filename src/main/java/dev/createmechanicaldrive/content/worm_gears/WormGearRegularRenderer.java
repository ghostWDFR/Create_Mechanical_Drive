...
public class WormGearRegularRenderer
        extends KineticBlockEntityRenderer<
        WormGearRegularBlockEntity
        > {
    ...
    public WormGearRegularRenderer(
    ...
    protected void renderSafe(
            WormGearRegularBlockEntity blockEntity,
            float partialTicks,
            PoseStack poseStack,
        ...
        if (state.getValue(WormGearRegularBlock.ENCASED)) {
            Direction.Axis axis =
                    state.getValue(
                            WormGearRegularBlock.AXIS
                    );
