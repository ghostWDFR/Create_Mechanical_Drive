...
public class TankTransmissionHousingRenderer
        extends KineticBlockEntityRenderer<
        TankTransmissionHousingBlockEntity
        > {

    public TankTransmissionHousingRenderer(
    ...
    protected void renderSafe(
            TankTransmissionHousingBlockEntity blockEntity,
            float partialTicks,
            PoseStack poseStack,
        ...
        Direction.Axis axis = blockEntity
                .getBlockState()
                .getValue(TankTransmissionHousingBlock.AXIS);

        BlockState shaftState =
                KineticBlockEntityRenderer.shaft(axis);

        RenderType renderType =
                getRenderType(blockEntity, shaftState);

        SuperByteBuffer shaft =
                getRotatedModel(blockEntity, shaftState);
    ...
    private static int getShaftLight(
        ...
        Direction positive = Direction.get(
                Direction.AxisDirection.POSITIVE,
                axis
        );

        Direction negative = Direction.get(
