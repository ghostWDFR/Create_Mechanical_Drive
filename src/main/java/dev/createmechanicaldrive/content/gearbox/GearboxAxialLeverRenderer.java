...
public class GearboxAxialLeverRenderer
        implements BlockEntityRenderer<GearboxAxialLeverBlockEntity> {
    ...
    public GearboxAxialLeverRenderer(
    ...
    @Override
    public void render(
            GearboxAxialLeverBlockEntity blockEntity,
            float partialTick,
            PoseStack poseStack,
        ...
        float gateX = blockEntity.getAnimatedGateX(partialTick);
        float gateY = blockEntity.getAnimatedGateY(partialTick);

        Direction facing = blockEntity
                .getBlockState()
                .getValue(GearboxAxialLeverBlock.FACING);

        BakedModel handleModel = Minecraft.getInstance()
                .getModelManager()
                .getModel(
                        CreateMechanicalDriveClient
                                .GEARBOX_LEVER_AXIAL_HANDLE_MODEL
                );
        ...
        float xRotation = -gateY * MAX_TILT_RADIANS;
        float zRotation = -gateX * MAX_TILT_RADIANS;
